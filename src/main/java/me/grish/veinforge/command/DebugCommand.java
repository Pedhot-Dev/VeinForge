...
public class DebugCommand {
   ...
   public void pathStats() {
      ...
      String status = telemetry.isSuccess() ? "success" : "failed";
      String failureReason = telemetry.getFailureReason().isEmpty() ? "-" : telemetry.getFailureReason();
      ...
      Logger.sendMessage("[PathStats] expanded_nodes=" + telemetry.getExpandedNodes()
                                 + " open_set_peak=" + telemetry.getOpenSetPeak()
                                 + " iterations=" + telemetry.getIterations());
      Logger.sendMessage("[PathStats] path_length=" + telemetry.getPathLength()
                                 + " smoothed_path_length=" + telemetry.getSmoothedPathLength()
                                 + " direct_walk=" + telemetry.isDirectWalk());
   }
